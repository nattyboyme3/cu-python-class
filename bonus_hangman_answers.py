...
class HangmanGame:
    def __init__(self):
        ...
        #   Then, add each word to self.wordlist. Strip off any whitespace that may have snuck in there.
        for i in resp.text.split('\n'):
            self.wordlist.append(i.strip())
